...
4. Verify fresh and retained startup natively on Windows 11 x64.
...
- Native Windows startup/process cleanup results, including no descendants
  after normal, forced, and exit-7 shutdown.
...
Reproduce representative failures from every subsystem on Windows 11 x64 and
ensure all discovered production defects were returned to their owning workers
and re-reviewed.
