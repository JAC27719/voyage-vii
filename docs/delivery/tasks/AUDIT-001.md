...
5. Re-run fresh/retained managed mode, security checks, and the final Windows
   ZIP smoke test with the approved PACKAGE-004 harness and exact integrated
   artifact/runtime hashes.
